...
| Replication | Native Lavik replication, Redis PSYNC consumption and ScanReader export, destructive full sync, online logs, Sentinel role changes, Meta-managed bounded Candidate Recovery, direct-parent reparent, promotion/follow-owner control, replay, and the fail-closed single-group cluster boundary | [Replication](05-replication.md) |
