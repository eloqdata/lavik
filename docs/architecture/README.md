...
| Replication | Native Lavik replication, Redis PSYNC consumption, RedisShake managed import and ScanReader export, destructive full sync, online logs, Sentinel role changes, Meta-managed bounded Candidate Recovery, direct-parent reparent, promotion/follow-owner control, replay, and complete-population Single replica reads | [Replication](05-replication.md) |
