...
// Auxiliary records carry the complete parent key. Keep oversized keys on
// the legacy layout so segmenting their value cannot multiply key storage
// without bound (e.g. repeating a multi-MiB key once per 8 KiB segment).
